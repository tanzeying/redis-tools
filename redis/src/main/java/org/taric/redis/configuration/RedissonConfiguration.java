package org.taric.redis.configuration;

import org.taric.redis.aop.LockAop;
import org.taric.redis.operation.RedissonBinary;
import org.taric.redis.operation.RedissonCollection;
import org.taric.redis.operation.RedissonObject;
import org.taric.redis.properties.MultipleServerConfig;
    ...
    public RedissonClient redissonClient() {
        ...
        switch (redissonProperties.getModel()){
            case SINGLE:
                ...
                org.taric.redis.properties.SingleServerConfig param = redissonProperties.getSingleServerConfig();
